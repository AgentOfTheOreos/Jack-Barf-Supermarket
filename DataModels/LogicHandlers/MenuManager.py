...
!_____!!__!__!!_____!!__!__!     !_____!!__!__!!__!__!!__!   !__!!__!__!        !_____!!_____!!_____!!_____!7__7
        ...
        while True:
            ...
            if choice == "1":
                ...
                if not user.shopping_list:
                    ...
                    print('\n')
                    if shift.lower() not in ["morning", "evening", "midnight"]:
                        print("Invalid shift!")
                ...
                print("============================================")
                print(f"Customer's total account balance is {user.account_balance}")
                continue
            elif choice == "Q":
                self.menu_stack.pop()()
            else:
    ...
    def cashier_menu(self, user: Cashier):
        ...
        while True:
            ...
            if choice == "1":
                ...
                print("============================================")
                print(f"Total transactions for cashier is {user.get_total_transactions()}")
                continue
            elif choice == "Q":
                self.menu_stack.pop()()
            else:
    ...
    def add_product_prompt(self):
        ...
        while True:
            ...
            if location.lower() == "shelves":
                threading.Thread(target=self.add_item_to_shelves, args=(product,)).start()
            elif location.lower() == "storage room":
                threading.Thread(target=self.add_item_to_storage_room, args=(product,)).start()
            else:
                print("Invalid location, can either be shelves or storage room.")
            break

    def add_item_to_shelves(self, product):
        if self._supermarket.add_item_to_shelves(product):
            FileHandler.save_supermarket(self._supermarket)

    def add_item_to_storage_room(self, product):
    ...
    def add_employee_prompt(self):
        ...
        while True:
            ...
            threading.Thread(target=self.add_employee, args=(employee,)).start()
            break
    ...
    def search_orders_prompt(self):
        ...
        while True:
            ...
            if search_option == "1":
                ...
                print('\n')
                threading.Thread(target=self.display_filtered_orders, args=(category, query)).start()
                break
            elif search_option == "2":
                threading.Thread(target=self.display_orders).start()
                break
    ...
    def display_filtered_orders(self, category, query):
    ...
    def search_employees_prompt(self):
        ...
        while True:
            ...
            if search_option == "1":
                ...
                query = input("Enter the query: ")
                print('\n')
                threading.Thread(target=self.search_employees, args=(category, query)).start()
                break
            elif search_option == "2":
                threading.Thread(target=self.display_employees).start()
                break
            elif search_option == "Q":
                break
            else:
    ...
    def search_employees(self, category, query):
    ...
    def search_shelves_prompt(self):
        ...
        while True:
            ...
            if search_option == "1":
                ...
                query = input("Enter the query: ")
                print('\n')
                threading.Thread(target=self.search_items_on_shelves, args=(category, query)).start()
                break
            elif search_option == "2":
                threading.Thread(target=self.display_products_on_shelves).start()
                break
            elif search_option == "Q":
                break
            else:
    ...
    def search_items_on_shelves(self, category, query):
    ...
    def search_storage_room_prompt(self):
        ...
        while True:
            ...
            if search_option == "1":
                ...
                query = input("Enter the query: ")
                print('\n')
                threading.Thread(target=self.search_items_in_storage_room, args=(category, query)).start()
                break
            elif search_option == "2":
                threading.Thread(target=self.display_products_in_storage).start()
                break
            elif search_option == "Q":
                break
            else:
    ...
    def search_items_in_storage_room(self, category, query):
